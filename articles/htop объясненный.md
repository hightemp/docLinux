...
*   [До](#user-content-23)
*   [`/sbin/init`]()
*   [`/lib/systemd/systemd-journald`](#user-content-24)
*   [`/sbin/lvmetad -f`](#user-content-25)
*   [`/lib/systemd/udevd`](#user-content-26)
*   [`/lib/systemd/timesyncd`](#user-content-27)
*   [`/usr/sbin/atd -f`](#user-content-28)
*   [`/usr/lib/snapd/snapd`](#user-content-29)
*   [`/usr/bin/dbus-daemon`](#user-content-30)
*   [`/lib/systemd/systemd-logind`](#user-content-31)
*   [`/usr/sbin/cron -f`](#user-content-32)
*   [`/usr/sbin/rsyslogd -n`](#user-content-33)
*   [`/usr/sbin/acpid`](#user-content-34)
*   [`/usr/bin/lxcfs /var/lib/lxcfs/`](#user-content-35)
*   [`/usr/lib/accountservice/accounts-daemon`](#user-content-36)
*   [`/sbin/mdadm`](#user-content-37)
*   [`/usr/lib/policykit-1/polkitd --no-debug`](#user-content-38)
*   [`/usr/sbin/sshd -D`](#user-content-39)
*   [`/sbin/iscsid`](#user-content-40)
*   [`/sbin/agetty --noclear tty1 linux`](#user-content-41)
*   [`sshd: root@pts/0`&`-bash`&`htop`](#user-content-42)
*   [После](#user-content-43)
*   [аппендикс](#user-content-44)
*   [Исходный код](#user-content-45)
*   [Файловые дескрипторы и перенаправление](#user-content-46)
*   [Цвета в PuTTY](#user-content-47)
*   [Shell в C](#user-content-48)
*   [TODO](#user-content-49)
*   [Обновления](#user-content-50)
