...
*   [htop на Ubuntu Server 16.04 x64](#user-conent-1)
*   [Uptime](#user-conent-2)
*   [Средняя нагрузка](#user-conent-3)
*   [Процессы](#user-conent-4)
*   [ID / PID процесса](#user-conent-5)
*   [Дерево процессов](#user-conent-6)
*   [Пользователь процесса](#user-conent-7)
*   [Состояние процесса](#user-conent-8)
*   [R - работает или работает (в очереди выполнения)](#user-conent-9)
*   [S - прерывистый сон (ожидание завершения события)](#user-conent-10)
*   [D - непрерывный сон (обычно IO)](#user-conent-11)
*   [Z - не существующий ("зомби") процесс, завершенный, но не собранный его родителем](#user-conent-12)
*   [T - остановлено сигналом управления работой](#user-conent-13)
*   [t - остановлен отладчиком во время трассировки](#user-conent-14)
*   [Время процесса](#user-conent-15)
*   [Любезность процессов и приоритеты](#user-conent-16)
*   [Использование памяти - VIRT/RES/SHR/MEM](#user-conent-17)
*   [VIRT/VSZ - виртуальный образ](#user-conent-18)
*   [RES/RSS - Размер резидента](#user-conent-19)
*   [SHR - размер общей памяти](#user-conent-20)
*   [MEM% - использование памяти](#user-conent-21)
*   [Процессы](#user-conent-22)
*   [До](#user-conent-23)
*   [`/sbin/init`]()
*   [`/lib/systemd/systemd-journald`](#user-conent-24)
*   [`/sbin/lvmetad -f`](#user-conent-25)
*   [`/lib/systemd/udevd`](#user-conent-26)
*   [`/lib/systemd/timesyncd`](#user-conent-27)
*   [`/usr/sbin/atd -f`](#user-conent-28)
*   [`/usr/lib/snapd/snapd`](#user-conent-29)
*   [`/usr/bin/dbus-daemon`](#user-conent-30)
*   [`/lib/systemd/systemd-logind`](#user-conent-31)
*   [`/usr/sbin/cron -f`](#user-conent-32)
*   [`/usr/sbin/rsyslogd -n`](#user-conent-33)
*   [`/usr/sbin/acpid`](#user-conent-34)
*   [`/usr/bin/lxcfs /var/lib/lxcfs/`](#user-conent-35)
*   [`/usr/lib/accountservice/accounts-daemon`](#user-conent-36)
*   [`/sbin/mdadm`](#user-conent-37)
*   [`/usr/lib/policykit-1/polkitd --no-debug`](#user-conent-38)
*   [`/usr/sbin/sshd -D`](#user-conent-39)
*   [`/sbin/iscsid`](#user-conent-40)
*   [`/sbin/agetty --noclear tty1 linux`](#user-conent-41)
*   [`sshd: root@pts/0`&`-bash`&`htop`](#user-conent-42)
*   [После](#user-conent-43)
*   [аппендикс](#user-conent-44)
*   [Исходный код](#user-conent-45)
*   [Файловые дескрипторы и перенаправление](#user-conent-46)
*   [Цвета в PuTTY](#user-conent-47)
*   [Shell в C](#user-conent-48)
*   [TODO](#user-conent-49)
*   [Обновления](#user-conent-50)
