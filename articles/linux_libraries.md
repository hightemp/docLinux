...
Источник: [БИБЛИОТЕКИ LINUX](https://losst.pro/biblioteki-linux)
...
* [ЧТО ТАКОЕ БИБЛИОТЕКИ?](#user-content-что-такое-библиотеки)
* [КАК ПОЛУЧИТЬ ИНФОРМАЦИЮ О БИБЛИОТЕКАХ?](#user-content-как-получить-информацию-о-библиотеках)
* [ОСНОВНЫЕ БИБЛИОТЕКИ](#user-content-основные-библиотеки)
  * [БИБЛИОТЕКИ КОДЕКОВ](#user-content-библиотеки-кодеков)
  * [ЗВУКОВЫЕ БИБЛИОТЕКИ](#user-content-звуковые-библиотеки)
  * [РАБОТА С АРХИВАМИ](#user-content-работа-с-архивами)
  * [ГРАФИЧЕСКИЕ БИБЛИОТЕКИ](#user-content-графические-библиотеки)
  * [РАБОТА С ТЕКСТОМ](#user-content-работа-с-текстом)
  * [БЕЗОПАСНОСТЬ](#user-content-безопасность)
  * [БИБЛИОТЕКИ ДРАЙВЕРОВ](#user-content-библиотеки-драйверов)
  * [СЕТЬ](#user-content-сеть)
  * [ЭМУЛЯЦИЯ](#user-content-эмуляция)
