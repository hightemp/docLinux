...
Источник: [Ограничение использования процессора с помощью nice, cpulimit и cgroups](https://www.tecmint.com/limit-cpu-usage-of-a-process-in-linux-with-cpulimit-tool/)
