...
Источник: [И еще о специальном файле устройства /dev/tcp (TCP/IP), встроенном в bash](https://www.linuxjournal.com/content/more-using-bashs-built-devtcp-file-tcpip)
